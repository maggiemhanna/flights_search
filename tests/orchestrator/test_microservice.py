...
BASE_URL = "https://orchestrator-service-874751466618.europe-west9.run.app"
...
def test_run_orchestrator():
    """Test the orchestrator endpoint and validate the exact JSON structure."""
    ...
    for test in tests:        
        ...
        response = requests.post(f"{BASE_URL}/run-orchestrator", json=payload)
