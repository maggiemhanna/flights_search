...
# Import the FastAPI app from your main2.py file.
try:
    from agents.flights_search.main2 import api 
except ImportError:
    logger.error("Could not import 'api' from 'main2.py'")
    sys.exit(1)
...
def test_root_endpoint():
    ...
    assert response.json() == {"message": "Flights Search Agent Service (SerpApi) is running."}
